...
''')
    ...
    def test__kai_int4_mm_channelwise(self, device, m, k, n):
        ...
        def convert_weight_to_int4pack(weight):
            ...
            weight_int4pack = torch._kai_weight_pack_int4(weight_uint8,weight_scales_and_zeros,weight.shape[-2],weight.shape[-1],0)

            return weight_int4pack

        def weight_int4pack_mm(input, weight_int4pack, weight):
            return torch._kai_input_quant_mm_int4(input, weight_int4pack, input.shape[-2],weight.shape[-2], weight.shape[-1], 0)
    ...
    def test__kai_int4_mm_groupwise(self, device, m, k, n):
        ...
        def convert_weight_to_int4pack(weight):
            ...
            weight_int4pack = torch._kai_weight_pack_int4(weight_uint8,weight_scales_and_zeros,weight.shape[-2],weight.shape[-1],q_group)

            return weight_int4pack

        def weight_int4pack_mm(input, weight_int4pack, weight):
            return torch._kai_input_quant_mm_int4(input, weight_int4pack, input.shape[-2],weight.shape[-2], weight.shape[-1], q_group)
